package com.example.richibp.conversoreh;
...
final String[] datos = new String[] {"DÓLAR","EURO","PESO MEXICANO"};
    ...
    public void clickConvertir(View v) {
        ...
        } else
        {
            ...
            Toast.makeText(MainActivityEH.this, "Las opciones elegidas no tienen un factor de conversion",Toast.LENGTH_SHORT).show();
